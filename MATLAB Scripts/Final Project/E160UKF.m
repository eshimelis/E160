...
logfilename = 'Bot0_2018_04_20_20_13_21';
...
plot(state.XEst, state.YEst, 'linewidth', 4);
...
title('Overhead Map Hardware Feedback Test 2', 'Interpreter', 'Latex');
xlabel('X Position (m)', 'Interpreter', 'Latex');
ylabel('Y Position (m)', 'Interpreter', 'Latex');
legend('Odometry Estimate', 'Filter Estimate', 'Location', 'northeast');
